...
const LoginScreen: React.FC = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme === 'light' ? '#F3F4F6' : '#1F2937' }]}>
      ...
      <Text style={[styles.title, { color: theme === 'light' ? '#111827' : '#F9FAFB' }]}>Welcome Back</Text>
      <TextInput
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Register')}>
        <Text style={[styles.linkText, { color: theme === 'light' ? '#4B5563' : '#D1D5DB' }]}>Don't have an account? Sign up</Text>
      </TouchableOpacity>
    </View>
  );
};
